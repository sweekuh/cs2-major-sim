...
- [ ] **Phase 5: Odds Ensemble** - Three-provider log-opinion pool, ratings back-solve, epistemic outer loop, read-only cache seam; fails soft, never gates (🔄 IN PROGRESS — 05-01 of 3 done 2026-05-29)
